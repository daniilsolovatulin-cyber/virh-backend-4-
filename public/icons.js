const ICONS = {
  logo: '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L3 7v10l9 5 9-5V7z"/><path d="M3 7l9 5 9-5M12 12v10"/></svg>',
  ...
  heart: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.8 4.6a5.5 5.5 0 00-7.8 0L12 5.6l-1-1a5.5 5.5 0 00-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 000-7.8z"/></svg>',
  ...
  cross: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6L6 18M6 6l12 12"/></svg>',
  ...
  home: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg>',
  tag: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41L11 3.83A2 2 0 009.6 3.2L3.2 9.6a2 2 0 00-.6 1.4L11.17 20.6a2 2 0 002.83 0l6.6-6.6a2 2 0 000-2.83z"/><circle cx="7.5" cy="7.5" r="1.5"/></svg>',
  ...
  flame: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2c1 4-4 5-4 10a4 4 0 008 0c0-2-1-3-1-3s2 1 2 4a6 6 0 01-12 0c0-5 4-6 4-10 0-1 1-2 3-1z"/></svg>',
  trophy: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 21h8M12 17v4M17 4H7v4a5 5 0 0010 0V4z"/><path d="M17 5h3a2 2 0 01-2 4M7 5H4a2 2 0 002 4"/></svg>',
  ...
  wifi: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.55a11 11 0 0114.08 0M1.42 9a16 16 0 0121.16 0M8.53 16.11a6 6 0 016.95 0M12 20h.01"/></svg>',
  ...
  medal: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="6"/><path d="M8.5 13.5L7 22l5-3 5 3-1.5-8.5"/></svg>',
};

/* The shared M3 expressive indicator used outside the two percentage rings.
   variant: 'inline' sits in buttons/rows; 'full' occupies empty/loading panels. */
function LOADER(variant = 'inline') {
  return `<svg class="loader loader--${variant}" viewBox="0 0 200 200" role="progressbar" aria-label="Загрузка" aria-busy="true">
    <g class="loader__group"><path class="loader__shape" d="M 100,66 C 108.85,66 117.79,69.7 124.04,75.96 C 130.3,82.21 134,91.15 134,100 C 134,108.85 130.3,117.79 124.04,124.04 C 117.79,130.3 108.85,134 100,134 C 91.15,134 82.21,130.3 75.96,124.04 C 69.7,117.79 66,108.85 66,100 C 66,91.15 69.7,82.21 75.96,75.96 C 82.21,69.7 91.15,66 100,66 Z"/></g>
    <circle class="loader__drop" style="--drop-angle:0deg" cx="100" cy="100" r="8"/>
    <circle class="loader__drop" style="--drop-angle:90deg" cx="100" cy="100" r="8"/>
    <circle class="loader__drop" style="--drop-angle:180deg" cx="100" cy="100" r="8"/>
    <circle class="loader__drop" style="--drop-angle:270deg" cx="100" cy="100" r="8"/>
  </svg>`;
}
